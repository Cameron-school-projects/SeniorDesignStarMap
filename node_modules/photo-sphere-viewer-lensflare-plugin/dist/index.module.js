import { utils, PSVError, TypedEvent, AbstractPlugin, events } from '@photo-sphere-viewer/core';
import { BufferGeometry, InterleavedBuffer, InterleavedBufferAttribute, Mesh, MeshBasicMaterial, Vector3, FramebufferTexture, RGBAFormat, RawShaderMaterial, Color, Vector2, AdditiveBlending, Box2, Vector4, TextureLoader, PointLight, PlaneGeometry, Group } from 'three';
 ...
 */
class LensflaresPluginEvent extends TypedEvent {
}
/**
...
class LensflarePlugin extends AbstractPlugin {
    constructor(viewer, config) {
        super(viewer);
        this.lensflares = {};
        this.state = {
