...
import { utils, AbstractPlugin, events, PSVError, TypedEvent } from '@photo-sphere-viewer/core';
import { BufferGeometry, InterleavedBuffer, InterleavedBufferAttribute, Mesh, MeshBasicMaterial, Vector3, FramebufferTexture, RGBAFormat, RawShaderMaterial, Color, Vector2, AdditiveBlending, Box2, TextureLoader, PointLight, PlaneGeometry, Group, Vector4 } from '../../three/build/three.module.js';
var Lensflare = /*#__PURE__*/function (_Mesh) {
  ...
  function Lensflare() {
    ...
    // textures
    var tempMap = new FramebufferTexture(16, 16, RGBAFormat);
    var occlusionMap = new FramebufferTexture(16, 16, RGBAFormat);
    // material
 ...
 * @internal
 */
var LENSFLARE_DATA = 'psvLensflare';
/**
 * Property name added to lensflare elements (dash-case)
 * @internal
 */
utils.dasherize(LENSFLARE_DATA);
...
var LensflareObject = /*#__PURE__*/function () {
  function LensflareObject(viewer, config) {
    ...
    this.refreshAfterLoad = function (texture) {
      texture.anisotropy = 4;
      _this2.viewer.needsUpdate();
    };
    if (!config.id) {
  ...
  _createClass(LensflareObject, [{
    ...
    key: "addLight",
    value: function addLight(h, s, l, x, y, z) {
    ...
    value: function update(config) {
      ...
      this.config = utils.deepmerge(this.config, config);
    ...
    key: "__update3d",
    value: function __update3d() {
      var _this$config$opacity;
      var element = this.threeElement;
      ...
      element.children[0].material.opacity = (_this$config$opacity = this.config.opacity) !== null && _this$config$opacity !== void 0 ? _this$config$opacity : 1;
    ...
    value: function __createMesh() {
      var p = this.viewer.dataHelper.sphericalCoordsToVector3(this.state.position);
      //console.log(p)
      var light = this.addLight(this.config.color.h, this.config.color.s, this.config.color.l, p.x, p.y, 1);
      var material = new MeshBasicMaterial({
        transparent: true,
        opacity: 1,
        depthTest: false
      });
      var geometry = new PlaneGeometry(0, 0);
      var mesh = new Mesh(geometry, material);
      mesh.userData = _defineProperty({}, LENSFLARE_DATA, this);
      var element = new Group().add(mesh).add(light);
      ...
      Object.defineProperty(element, 'visible', {
        enumerable: true,
        get: function get() {
          return this.children[0].userData[LENSFLARE_DATA].visible;
        },
        set: function set(visible) {
          this.children[0].userData[LENSFLARE_DATA].visible = visible;
        }
      });
      return element;
    }
  }]);
  return LensflareObject;
}();
/**
 * Base class for events dispatched by {@link LensflaresPlugin}
 */
var LensflaresPluginEvent = /*#__PURE__*/function (_TypedEvent) {
  _inherits(LensflaresPluginEvent, _TypedEvent);
  var _super2 = _createSuper(LensflaresPluginEvent);
  function LensflaresPluginEvent() {
    _classCallCheck(this, LensflaresPluginEvent);
    return _super2.apply(this, arguments);
  }
  return _createClass(LensflaresPluginEvent);
}(TypedEvent);
/**
 * @event Triggered when the visibility of a lensflare changes
 */
var LensflareVisibilityEvent = /*#__PURE__*/function (_LensflaresPluginEven) {
  _inherits(LensflareVisibilityEvent, _LensflaresPluginEven);
  var _super3 = _createSuper(LensflareVisibilityEvent);
  function LensflareVisibilityEvent(lensflare, visible) {
    var _this3;
    _classCallCheck(this, LensflareVisibilityEvent);
    _this3 = _super3.call(this, LensflareVisibilityEvent.type);
    _this3.lensflare = lensflare;
    _this3.visible = visible;
    return _this3;
  }
  return _createClass(LensflareVisibilityEvent);
}(LensflaresPluginEvent);
LensflareVisibilityEvent.type = 'lensflare-visibility';
/**
 * @event Triggered when the lensflares change
 */
var SetLensflaresEvent = /*#__PURE__*/function (_LensflaresPluginEven2) {
  _inherits(SetLensflaresEvent, _LensflaresPluginEven2);
  var _super4 = _createSuper(SetLensflaresEvent);
  function SetLensflaresEvent(lensflares) {
    var _this4;
    _classCallCheck(this, SetLensflaresEvent);
    _this4 = _super4.call(this, SetLensflaresEvent.type);
    _this4.lensflares = lensflares;
    return _this4;
  }
  return _createClass(SetLensflaresEvent);
}(LensflaresPluginEvent);
SetLensflaresEvent.type = 'set-lensflares';
var getConfig = utils.getConfigParser({
  lensflares: null
});
var LensflarePlugin = /*#__PURE__*/function (_AbstractPlugin) {
  _inherits(LensflarePlugin, _AbstractPlugin);
  var _super5 = _createSuper(LensflarePlugin);
  function LensflarePlugin(viewer, config) {
    var _this5;
    _classCallCheck(this, LensflarePlugin);
    _this5 = _super5.call(this, viewer);
    _this5.lensflares = {};
    _this5.state = {
      visible: true,
      currentLensflare: null,
      hoveringLensflare: null
    };
    _this5.config = getConfig(config);
    _this5.renderLensflares();
    return _this5;
  }
  _createClass(LensflarePlugin, [{
    key: "init",
    value: function init() {
      _get(_getPrototypeOf(LensflarePlugin.prototype), "init", this).call(this);
    ...
    value: function destroy() {
      ...
      _get(_getPrototypeOf(LensflarePlugin.prototype), "destroy", this).call(this);
    }
    /**
    * @internal
    */
    ...
    key: "toggleAllLensflares",
    value: function toggleAllLensflares() {
      var _iterator = _createForOfIteratorHelper(this.getLensflares()),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var lensflare = _step.value;
    ...
    key: "showAllLensflares",
    value: function showAllLensflares() {
      var _iterator2 = _createForOfIteratorHelper(this.getLensflares()),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var lensflare = _step2.value;
    ...
    key: "hideAllLensflares",
    value: function hideAllLensflares() {
      var _iterator3 = _createForOfIteratorHelper(this.getLensflares()),
        _step3;
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          var lensflare = _step3.value;
    ...
    key: "getNbLensflares",
    value: function getNbLensflares() {
    ...
    key: "addLensflare",
    value: function addLensflare(config) {
      var render = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      if (this.lensflares[config.id]) {
        throw new PSVError("lensflare \"".concat(config.id, "\" already exists"));
      }
      var lensflare = new LensflareObject(this.viewer, config);
    ...
    key: "getLensflare",
    value: function getLensflare(lensflareId) {
      var id = _typeof(lensflareId) === 'object' ? lensflareId.id : lensflareId;
      if (!this.lensflares[id]) {
        throw new PSVError("cannot find lensflare \"".concat(id, "\""));
      }
    ...
    key: "getCurrentLensflare",
    value: function getCurrentLensflare() {
    ...
    key: "updateLensflare",
    value: function updateLensflare(config) {
      var render = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      var lensflare = this.getLensflare(config.id);
    ...
    key: "removeLensflare",
    value: function removeLensflare(lensflareId) {
      var render = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      var lensflare = this.getLensflare(lensflareId);
    ...
    key: "removeLensflares",
    value: function removeLensflares(lensflareIds) {
      var _this6 = this;
      var render = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      lensflareIds.forEach(function (lensflareId) {
        return _this6.removeLensflare(lensflareId, false);
      });
      if (render) {
        this.__afterChangerLensflares();
      }
    ...
    key: "setLensflares",
    value: function setLensflares(lensflares) {
      var _this7 = this;
      var render = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      this.clearLensflares(false);
      lensflares === null || lensflares === void 0 ? void 0 : lensflares.forEach(function (lensflare) {
        _this7.addLensflare(lensflare, false);
      });
      if (render) {
        this.__afterChangerLensflares();
      }
    ...
    key: "clearLensflares",
    value: function clearLensflares() {
      var _this8 = this;
      var render = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      Object.keys(this.lensflares).forEach(function (lensflareId) {
        _this8.removeLensflare(lensflareId, false);
      });
      if (render) {
        this.__afterChangerLensflares();
      }
    ...
    key: "hideLensflare",
    value: function hideLensflare(lensflareId) {
    ...
    key: "showLensflare",
    value: function showLensflare(lensflareId) {
    ...
    */
    ...
    key: "toggleLensflare",
    value: function toggleLensflare(lensflareId, visible) {
      var lensflare = this.getLensflare(lensflareId);
    ...
    */
    ...
    key: "renderLensflares",
    value: function renderLensflares() {
      var _this9 = this;
      Object.values(this.lensflares).forEach(function (lensflare) {
        var isVisible = _this9.state.visible && lensflare.visible;
        ...
        if (visibilityChanged) {
          _this9.dispatchEvent(new LensflareVisibilityEvent(lensflare, isVisible));
        }
      });
    }
  }, {
    key: "__afterChangerLensflares",
    value: function __afterChangerLensflares() {
      this.viewer.needsUpdate();
